function [ret,sog_performance, stockpick]=Prod_sog_livetrading(topN,entryZscore,lookback,stckselectmode,spread_mode,write,data)
...
%Exit position 1: close at day close
 retO2C=(cl-op)./op;
...
ret_2018=ret(3274:end); ytd_2018=prod(1+ret_2018)-1; sharpe_2018=mean(ret_2018)*sqrt(252)/std(ret_2018); mdd_2018=maxdrawdown(100*cumprod(1+ret_2018));
ret_2017=ret(3023:3273); ytd_2017=prod(1+ret_2017)-1; sharpe_2017=mean(ret_2017)*sqrt(252)/std(ret_2017); mdd_2017=maxdrawdown(100*cumprod(1+ret_2017));
...
sog_performance.(naming)=mat2dataset(output_table,'VarNames',{'APR','SharpeRatio','maxDrawdown'},'ObsNames',{'Since Inception','Y2018','Y2017','Y2016','Y2015','Y2014','Y2013','Y2012','Y2011','Y2010','Y2009','Y2008','Y2007','Y2006'});
