function [bogret, sogret,bog_performance,sog_performance]=NUV_bogsog(location,stckselectmode,spread_mode)
...
[bogret,bog_performance, bogstockpick]=NUV_bog_livetrading(bogtopN,bogentryZscore,boglookback,stckselectmode,spread_mode,data);
[sogret,sog_performance, sogstockpick]=NUV_sog_livetrading(sogtopN,sogentryZscore,soglookback,stckselectmode,spread_mode,data);
