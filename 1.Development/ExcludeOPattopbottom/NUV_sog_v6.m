function [ret,sog_performance, stockpick]=NUV_sog_livetrading(topN,entryZscore,lookback,stckselectmode,spread_mode,data)
...
for t=2:size(cl, 1)
    hasData=find(isfinite(retGap(t, :)) & op(t, :) > sellPrice(t, :) & op(t, :) < ma(t, :) & op(t,:)<hi(t,:));
...
sog_performance.(naming)=mat2dataset(output_table,'VarNames',{'APR','SharpeRatio','maxDrawdown'},'ObsNames',{'Since Inception','Y2016','Y2015','Y2014','Y2013','Y2012','Y2011','Y2010','Y2009','Y2008','Y2007','Y2006','Y2005'});
