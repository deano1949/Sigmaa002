function [ret,bog_performance, stockpick]=Dev_bog_Noearningdates(topN,entryZscore,lookback,stckselectmode,spread_mode,write,data,trade_earndate)
%Buy on Gap strategy: additional analysis: no trading on earning dates, see
%if it improves PNL
