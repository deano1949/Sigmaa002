function [bogret,sogret,bog_performance,sog_performance,bsog_table]=Dev_bogsog_Noearningdates(location,write,stckselectmode,spread_mode)
% additional analysis: no trading on earning dates, see
%if it improves PNL
...
[bogret,bog_performance, bogstockpick]=Dev_bog_Noearningdates(bogtopN,bogentryZscore,boglookback,stckselectmode,spread_mode,write,data,trade_earndate);
[sogret,sog_performance, sogstockpick]=Dev_sog_Noearningdates(sogtopN,sogentryZscore,soglookback,stckselectmode,spread_mode,write,data,trade_earndate);
