function [ret,sog_performance, stockpick]=Dev_sog_stoplossonEarningdates(topN,entryZscore,lookback,stckselectmode,spread_mode,write,data,trade_earndate)
%SOG: Apply stop loss only on earning dates
...
%% if trade earning period
if strcmp(trade_earndate,'N')
    earndate=data.erndate;
    positionTable(earndate==1)=0;
end
...
sog_performance.(naming)=mat2dataset(output_table,'VarNames',{'APR','SharpeRatio','maxDrawdown'},'ObsNames',{'Since Inception','Y2017','Y2016','Y2015','Y2014','Y2013','Y2012','Y2011','Y2010','Y2009','Y2008','Y2007','Y2006'});
%save 'sog_performance.mat' sog_performance stockpick ret
if strcmp(write,'Y')
    outputfile='Matlab_simulation_output.xlsx';
    xlswrite(outputfile,naming,'MatlabSOGoutput','A2');
    xlswrite(outputfile,time,'MatlabSOGoutput','A10');
    xlswrite(outputfile,stockpick,'MatlabSOGoutput','B10');
    xlswrite(outputfile,ret,'MatlabSOGoutput','M10');
end