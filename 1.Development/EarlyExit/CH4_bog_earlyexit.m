...
if strcmp(exitmode, 'erex')
    ...
    threshold=Threshold.BOG;
    o2h=hi./op-1; %open2high 
    o2l=lo./op-1;
    o2c=cl./op-1;
    clposp1=(o2h<threshold).*o2c;
    clposp2=(o2h>=threshold).*threshold;
...
bog_performance_earlyexit.(naming)=mat2dataset(output_table,'VarNames',{'APR','SharpeRatio','maxDrawdown'},'ObsNames',{'Since Inception','Y2016','Y2015','Y2014','Y2013','Y2012','Y2011','Y2010','Y2009','Y2008','Y2007'});
bog_performance_earlyexit.retts(:,k)=ret;
k=k+1;
end

%% Write output into excel
% bog_performance_earlyexit=mat2dataset(output_table,'VarNames',{'APR','SharpeRatio','maxDrawdown'},'ObsNames',{'Since Inception','Y2016','Y2015','Y2014','Y2013','Y2012','Y2011','Y2010','Y2009','Y2008','Y2007'});
% save 'bog_performance_earlyexit.mat' bog_performance_earlyexit stockpick 
