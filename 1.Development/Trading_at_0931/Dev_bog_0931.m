function [ret,bog_performance, stockpick]=Dev_bog_0931(topN,entryZscore,lookback,stckselectmode,spread_mode,universe)
%Buy on Gap strategy

op=universe.O; cl=universe.C; hi=universe.H; lo=universe.L;name=universe.name; time=universe.time;
...
bog_performance.(naming)=mat2dataset(output_table,'VarNames',{'APR','SharpeRatio','maxDrawdown'},'ObsNames',{'Since Inception','Y2016','Y2015','Y2014','Y2013','Y2012','Y2011','Y2010','Y2009','Y2008','Y2007'});
